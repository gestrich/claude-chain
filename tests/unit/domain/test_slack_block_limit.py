...
class TestCompletedProjectsExcluded:
    """Completed projects (all tasks merged, no open PRs) should be excluded."""

    def test_completed_project_excluded_from_blocks(self):
    ...
    def test_all_completed_still_returns_valid_payload(self):
        report = StatisticsReport(repo="owner/repo")
    ...
    def test_partially_completed_project_included(self):
        report = StatisticsReport(repo="owner/repo")
