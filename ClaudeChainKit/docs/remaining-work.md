...
- [ ] **AutoStartCommand.swift** — Port `run()` from `cli/commands/auto_start.py`
...
- [ ] **CreateArtifactCommand.swift** — Port `run()` from `cli/commands/create_artifact.py`
...
- [ ] **DiscoverReadyCommand.swift** — Port `run()` from `cli/commands/discover_ready.py`
...
- [ ] **FinalizeCommand.swift** — Port `run()` from `cli/commands/finalize.py`
...
- [ ] **FormatSlackNotificationCommand.swift** — Port `run()` from `cli/commands/format_slack_notification.py`
...
- [ ] **ParseClaudeResultCommand.swift** — Port `run()` from `cli/commands/parse_claude_result.py`
...
- [ ] **ParseEventCommand.swift** — Port `run()` from `cli/commands/parse_event.py`
...
- [ ] **PostPRCommentCommand.swift** — Port `run()` from `cli/commands/post_pr_comment.py`
...
- [ ] **PrepareCommand.swift** — Port `run()` from `cli/commands/prepare.py`
...
- [ ] **PrepareSummaryCommand.swift** — Port `run()` from `cli/commands/prepare_summary.py`
...
- [ ] **RunActionScriptCommand.swift** — Port `run()` from `cli/commands/run_action_script.py`
...
- [ ] **SetupCommand.swift** — Port `run()` from `cli/commands/setup.py`
...
- [ ] **StatisticsCommand.swift** — Port `run()` from `cli/commands/statistics.py`
...
- [ ] **AutoStartSummaryCommand** — Verify argument definitions match Python
